...
<body class="d-flex align-items-center justify-content-center vh-100" style="background-color: #FEFBF6">
    <div class="container">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm" style="background-color: #FFEAC5">
                    <div class="card-body"> <!-- Centered content -->
                        ...
                        <h4 class="mb-4 text-center" style="color: #603F26">Forgot Password</h4>
                        ...
                        <p class="text-muted text-center" style="color: #6C4E31">Enter your registered email and click recovery account</p>
