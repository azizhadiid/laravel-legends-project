                        ...
                        <div class="card-body p-3 p-md-4 p-xl-5" style="background-color: #FFEAC5">
                            <div class="row">
                                <div class="col-12">
                                    <div
                                        ...
                                        <h4 class="" style="color: #603F26">Log in for an account!!</h4>
                            ...
                            <form method="POST" action="/login" class="mt-2">
                                ...
                                <div class="row gy-3 gy-md-4 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn login" type="submit">Log in now</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <div class="row">
                                <div class="col-12 mt-4">
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                        <a href="{{url('register')}}" class="link-secondary text-decoration-underline">Create new
                                            account</a>
                                        <a href="{{url('forgot-password')}}" class="link-secondary text-decoration-underline">Forgot
                                            password</a>
                                    </div>
                                </div>
                            </div>
